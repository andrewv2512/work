# Приложение "Банковский счёт пользователя"
...
6) После введения логина и пароля переходим в любой REST API-плагин для браузера и пользуемся. Перечень методов будет перечислен на странице Swagger во время работы приложения: http://localhost:8080/swagger-ui.html
